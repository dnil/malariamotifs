# $Id: Sbjct.pm,v 1.1.1.1 2009/09/23 10:46:03 daniel Exp $
###############################################################################
...
sub nextHSP {
  ...
  while( defined($_ = $self->_readline()) ) {
      ...
      elsif ($_ =~ /^>|^Histogram|^Searching|^Parameters|^\s+Database:|^CPU\stime|^\s*Lambda|^Underlying/)   
      {    
	  # added a final Underlying for IMPALA compatibility // DN 050816
